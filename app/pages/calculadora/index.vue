      ...
      <div class="form-container">
        ...
        <form @submit.prevent="handleSubmit" class="params-form">
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input 
                  id="anos_inversion"
                  type="number" 
                  v-model.number="formData.anos_inversion"
                  @input="updateParam('anos_inversion', $event.target.value)"
                  min="1"
                  max="50"
                  placeholder="10"
                />
          ...
          <div class="form-section">
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input 
                  id="tasa_cambio_usd_mxn"
                  type="text" 
                  v-model="formattedData.tasa_cambio_usd_mxn"
                  @input="updateCurrencyField('tasa_cambio_usd_mxn', $event.target.value)"
                />
              </div>
              <div class="form-group">
                <label for="tasa_inflacion_anual">Tasa de Inflación Anual (%)</label>
                <input 
                  id="tasa_inflacion_anual"
                  type="number" 
                  step="0.1"
                  v-model.number="formData.tasa_inflacion_anual"
                  @input="updateParam('tasa_inflacion_anual', $event.target.value)"
                />
              </div>
            </div>
          </div>
          ...
          <div class="form-section">
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input 
                  id="hrs_vuelo_nacionales_anual"
                  type="number" 
                  v-model.number="formData.hrs_vuelo_nacionales_anual"
                  @input="updateParam('hrs_vuelo_nacionales_anual', $event.target.value)"
                />
              </div>
              <div class="form-group">
                <label for="hrs_vuelo_extranjero_anual">Horas de Vuelo Extranjero Anual</label>
                <input 
                  id="hrs_vuelo_extranjero_anual"
                  type="number" 
                  v-model.number="formData.hrs_vuelo_extranjero_anual"
                  @input="updateParam('hrs_vuelo_extranjero_anual', $event.target.value)"
                />
              </div>
            </div>
          </div>
          ...
          <div class="form-section">
            ...
            <div class="form-grid">
              <div class="form-group">
                <label for="costo_turbocina_mex_lt">Costo Turbosina México (MXN/Lt)</label>
                <input 
                  id="costo_turbocina_mex_lt"
                  type="text" 
                  v-model="formattedData.costo_turbocina_mex_lt"
                  @input="updateCurrencyField('costo_turbocina_mex_lt', $event.target.value)"
                />
              </div>
              <div class="form-group">
                <label for="costo_turbocina_usa_gal">Costo Turbosina USA (USD/Gal)</label>
                <input 
                  id="costo_turbocina_usa_gal"
                  type="text" 
                  v-model="formattedData.costo_turbocina_usa_gal"
                  @input="updateCurrencyField('costo_turbocina_usa_gal', $event.target.value)"
                />
              </div>
              <div class="form-group">
                <label for="turbocina_mex_lt_hora">Turbosina México (Lt/Hora)</label>
                <input 
                  id="turbocina_mex_lt_hora"
                  type="number" 
                  v-model.number="formData.turbocina_mex_lt_hora"
                  @input="updateParam('turbocina_mex_lt_hora', $event.target.value)"
                />
              </div>
              <div class="form-group">
                <label for="turbocina_usa_gal_hora">Turbosina USA (Gal/Hora)</label>
                <input 
                  id="turbocina_usa_gal_hora"
                  type="number" 
                  v-model.number="formData.turbocina_usa_gal_hora"
                  @input="updateParam('turbocina_usa_gal_hora', $event.target.value)"
                />
              </div>
            </div>
          </div>
          ...
          <div class="form-section">
            ...
            <div class="form-grid">
              <div class="form-group">
                <label for="costo_mtto_programado_total_anual">Costo Mtto Programado Total Anual (USD)</label>
                <input 
                  id="costo_mtto_programado_total_anual"
                  type="text" 
          ...
          <div class="form-section">
            ...
            <div class="form-grid">
              <div class="form-group">
                <label for="reserva_capacitacion_pilotos_anual">Reserva Capacitación Pilotos Anual (USD)</label>
                <input 
                  id="reserva_capacitacion_pilotos_anual"
                  type="text" 
              ...
              <div class="form-group">
                <label for="administracion_anual">Administración Anual (USD)</label>
                <input 
                  id="administracion_anual"
                  type="text" 
                  v-model="formattedData.administracion_anual"
                  @input="updateCurrencyField('administracion_anual', $event.target.value)"
                />
              </div>
            </div>
          </div>
          ...
          <div class="form-section">
            ...
            <div class="form-grid">
              <div class="form-group">
                <label for="sueldo_piloto_pic_anual">Sueldo Piloto PIC Anual (USD)</label>
                <input 
                  id="sueldo_piloto_pic_anual"
                  type="text" 
                  v-model="formattedData.sueldo_piloto_pic_anual"
                  @input="updateCurrencyField('sueldo_piloto_pic_anual', $event.target.value)"
                />
              </div>
              <div class="form-group">
                <label for="sueldo_piloto_sic_anual">Sueldo Piloto SIC Anual (USD)</label>
                <input 
                  id="sueldo_piloto_sic_anual"
                  type="text" 
                  v-model="formattedData.sueldo_piloto_sic_anual"
          ...
          <div class="form-section">
            ...
            <div class="form-grid">
              <div class="form-group">
                <label for="guardia_hangar_anual">Guardia Hangar Anual (USD)</label>
                <input 
                  id="guardia_hangar_anual"
                  type="text" 
                  v-model="formattedData.guardia_hangar_anual"
                  @input="updateCurrencyField('guardia_hangar_anual', $event.target.value)"
                />
              </div>
              <div class="form-group">
                <label for="seguro_aeronave_anual">Seguro Aeronave Anual (USD)</label>
                <input 
                  id="seguro_aeronave_anual"
                  type="text" 
                  v-model="formattedData.seguro_aeronave_anual"
                  @input="updateCurrencyField('seguro_aeronave_anual', $event.target.value)"
                />
              </div>
              <div class="form-group">
                <label for="arrendamiento_anual">Arrendamiento Anual (USD)</label>
                <input 
                  id="arrendamiento_anual"
                  type="text" 
                  v-model="formattedData.arrendamiento_anual"
                  @input="updateCurrencyField('arrendamiento_anual', $event.target.value)"
                />
              </div>
              <div class="form-group">
                <label for="precio_venta_aeronave">Precio de Venta de Aeronave (USD)</label>
                <input 
                  id="precio_venta_aeronave"
                  type="text" 
                  v-model="formattedData.precio_venta_aeronave"
                  @input="updateCurrencyField('precio_venta_aeronave', $event.target.value)"
                />
              </div>
            </div>
          </div>

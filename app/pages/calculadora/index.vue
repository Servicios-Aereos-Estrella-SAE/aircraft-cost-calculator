      ...
      <div class="form-container">
        ...
        <form @submit.prevent="handleSubmit" class="params-form">
            ...
            <div class="form-grid">
              ...
              <div class="form-group">
                ...
                <input id="tasa_inflacion_usa" type="text" v-model="formattedData.tasa_inflacion_usa"
                  @input="updateCurrencyField('tasa_inflacion_usa', $event.target.value)" />
              </div>
              <div class="form-group">
          ...
          <div class="form-section">
            ...
            <div class="form-grid">
              <div class="form-group edited-warn">
          ...
          <div class="form-section">
            ...
            <div class="form-grid">
              <div class="form-group edited-warn">
                <label for="guardia_hangar_anual">Guarda Hangar Anual (USD)</label>
